# superPod (no-ext-dep-workaround branch)
...
> [!TIP]
> This branch utilizes `AudioTools` and `ESP32-A2DP` libraries for Bluetooth A2DP Sink audio streaming and I2S output.
...
1. **Clone the Repository**:
   ...
   cd superPod
   git checkout no-ext-dep-workaround
   ```
